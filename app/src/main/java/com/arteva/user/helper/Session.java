...
public class Session {
    ...
    public static final String LOGIN_AUTH_ID = "login_auth_id";
    ...
    public static void setLoginMobileNumber(String value, Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(LOGIN_MOBILE, value);
        editor.apply();
    }

    public static String getLoginMobileNumber(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        return sharedPreferences.getString(LOGIN_MOBILE, "");
    }

    public static void setLoginToken(String value, Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = sharedPreferences.edit();
    ...
    public static void setLoginAuthId(String value, Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(LOGIN_AUTH_ID, value);
        editor.apply();
    }

    public static String getLoginAuthId(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        return sharedPreferences.getString(LOGIN_AUTH_ID, "");
    }
    ...
    public static void saveUserDetail(Context context, String userId, String name, String email, String mobile, String profile, String referCode, String type, String classString, String subjectString, String isSubscribed) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        ...
        editor.putString(CLASS_, classString);
        editor.putString(SUBJECT, subjectString);
        editor.putBoolean(LOGIN, true);
        editor.putString(IS_SUBSCRIBED, isSubscribed);
        editor.apply();
    }
    ...
    public static void clearUserSession(Context mContext) {
        if (mContext != null) {
            SharedPreferences mSharedPreferences = PreferenceManager.getDefaultSharedPreferences(mContext);
            if (mSharedPreferences != null) {
                mSharedPreferences.edit().remove(IS_SUBSCRIBED).apply();
                ...
                mSharedPreferences.edit().remove(LOGIN_MOBILE).apply();
                mSharedPreferences.edit().remove(LOGIN_AUTH_ID).apply();
                mSharedPreferences.edit().remove(LOGIN_TOKEN).apply();
            }
        }
    }

...
public class NewSelfChallengeActivity extends AppCompatActivity {
    public ArrayList<Category_> categoryList, subCateList;
    Toolbar toolbar;
                    ...
                    if (error.equalsIgnoreCase("false")) {
                        ...
                        cateSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                                Category_ cate = categoryList.get(i);
                                cateId = cate.getId();
                ...
                try {
                    ...
                    if (error.equalsIgnoreCase("false")) {
                        ...
                        subCateSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                            @Override
                            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                                Category_ subCate = subCateList.get(i);
    ...
    public class CustomAdapter extends BaseAdapter {
        ArrayList<Category_> cateList;
        String type;

        public CustomAdapter(ArrayList<Category_> cateList, String type) {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            Category_ category = cateList.get(i);

package com.arteva.user.Categories.adapter
...
import com.arteva.user.databinding.ItemCategoryBinding
...
class CategoriesRvAdapter(
    ...
    private val activity: MainActivityCat,
) :
    ...
    override fun onBindChildViewHolder(
        ...
        holder.binding.itemCategoryDescTv.text = ("${category.count} ${context.getString(R.string.courses)}")
    ...
    override fun onBindGroupViewHolder(
        ...
        holder.binding.itemCategoryDescTv.text = ("${categoryView.count} ${context.getString(R.string.features)}")

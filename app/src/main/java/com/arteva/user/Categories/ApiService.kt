...
import com.arteva.user.manager.BuildVars
import com.arteva.user.manager.net.ApiClient
import com.arteva.user.manager.net.DownloadApiClient
import com.arteva.user.manager.net.OnDownloadProgressListener
import com.arteva.user.manager.net.ProgressResponseBody
...
object ApiService {
    ...
    var activity: MainActivityCat? = null

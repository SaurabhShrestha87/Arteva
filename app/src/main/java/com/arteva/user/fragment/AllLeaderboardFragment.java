package com.arteva.user.fragment;

import static com.arteva.user.Constant.PAGE_LIMIT;
...
import com.arteva.user.activity.LeaderboardAdapter;
...
import com.arteva.user.helper.UserSessionManager;
import com.arteva.user.helper.Utils;
import com.arteva.user.model.LeaderBoard;
import com.arteva.user.model.Model;
...
public class AllLeaderboardFragment extends Fragment {
    ...
    private final List<Model> historyList = new ArrayList<>();

...
public class Constant {
    ...
    private static final String DOMAIN_URL = "https://credinopos.in/arteva/"; //domain or admin panel url
    private static final String PUBLIC_URL = "https://credinopos.in/arteva/public"; //domain or admin panel url
    ...
    public static String class_ = "class_";
    public static String subject_ = "subject_";
    ...
    ////////////////////////////SUBJECT COURSES OR SMT//////////////////////////////////
    public static String status = "status";
    ////////////////////////////SUBJECT COURSES OR SMT//////////////////////////////////
    public static String ipAddress = "ip_address";
    public static String getCategories = "get_categories";
    public static String getCourses = "get_courses";
    public static String getClassSubject = "get_class_subject";
    public static String getEducation = "get_education";
    public static String getApiKey = "get_api_key";
    public static String setSubscription = "set_subscription";
    ...
    /////////////VIDEOS and SUBJECTS/////////////
    public static String GET_VIDEO_BY_SUBJECT = "get_videos_by_subject";
    ...
    public static String CUSTOM_OPTIONS = "custom_options";
    ...
    //Spinners Education. City, Board
    public static String CITY_DATA = "city_data";
    public static String EDU_DATA = "education_data";
    public static String BOARD_DATA = "board_data";
    public static String EDU_NAME = "education_name";
    //Class and Subjects
    public static String CLASS_NAME = "class_name";
    public static String SUBJECT_NAME = "subject_name";
    public static String SUBJECT_DATA = "subject_data";
    public static String KEY_SHARE_TEXT = "shareapp_text";
    public static String CATEGORY_NAME = "category_name";
    //VIDEO
    public static String VIDEO_ID_ = "id";
    public static String VIDEO_SUBJECT_ID = "subject_id";
    public static String VIDEO_NAME = "name";
    public static String VIDEO_IMAGE = "image";
    public static String VIDEO_MESSAGE = "message";
    ...
    public static String MEDIA_URL = PUBLIC_URL;  //media  url
